    ...
    <>
      ...
      <section className="w-full h-full flex flex-col justify-center items-center gap-5 mt-7">
          ...
          <div className="bg-white col-span-4 size-30 rounded-xl shadow-md">
            <div className="bg-linear-to-r from-black to-zinc-700 rounded-xl h-full w-full flex justify-evenly items-center pr-4 gap-6 relative">
              <div className="h-full w-full flex justify-center items-center gap-3 px-4 rounded-l-xl">
                <div className="flex flex-col gap-3">
                  <div className="relative bg-linear-to-r from-black to-blue-400 rounded-full">
                    <p className="absolute text-sm top-[3rem] right-[3rem] text-white">Oxygen Sat.</p>
                    <Gauge
                      {...settings_SPO2}
                      cornerRadius="50%"
                      sx={(theme) => ({
                  ...
                  <div className="relative bg-linear-to-r from-black to-blue-400  rounded-full">
                    <p className="absolute text-sm top-[3rem] right-[2.5rem] text-white">Beats Per Min.</p>
                    <Gauge
                      {...settings_BPM}
                      cornerRadius="50%"
                      sx={(theme) => ({
                ...
                <div className="flex flex-col gap-3">
                  <div className="relative bg-linear-to-r from-black to-blue-400  rounded-full">
                    <p className="absolute text-sm top-[3rem] right-[2.5rem] text-white">Blood Pressure</p>
                    <Gauge
                      {...settings_BP}
                      cornerRadius="50%"
                      sx={(theme) => ({
                  ...
                  <div className="relative bg-linear-to-r from-black to-blue-400  rounded-full">
                    <p className="absolute text-sm top-[3rem] right-[3rem] text-white">Temperature</p>
                    <Gauge
                      {...settings_TEMP}
                      cornerRadius="50%"
                      sx={(theme) => ({
              ...
              <div className="relative flex justify-center items-center w-full h-[80%]">
                <p className="absolute top-[-1rem] right-[6rem] text-blue-400 px-4 font-bold">Prediction</p>
                <RadarChart
                  height={300}
                  series={[
                    {
        ...
        <div className="border rounded-xl w-[80%] h-full grid grid-cols-6 gap-10">
          <div className="bg-linear-to-r from-black to-zinc-700 col-span-6 size-30 rounded-xl shadow-md"></div>
        </div>
      </section>
    </>
  );
